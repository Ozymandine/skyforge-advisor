...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "preconnect", href: "https://api.hypixel.net" },
...
function RootComponent() {
  ...
  // pages can never trap navigation. Offline support is provided by
  // react-query's persisted cache instead of a navigation-intercepting SW.
  useEffect(() => {
