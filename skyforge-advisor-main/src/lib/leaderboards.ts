...
export const LEADERBOARD_SUBCATEGORIES: LeaderboardSubcategory[] = [
  ...
  // ==========================================
  {
    ...
    iconId: "COAL",
    collectionKeys: ["COAL"],
    description: "Total coal mined or generated via minions.",
  },
  {
    id: "cobblestone",
    eliteId: "cobblestone",
    ...
    description: "Total cobblestone mined or generated.",
  },
  {
    id: "diamond",
    eliteId: "diamond",
  ...
  },
  {
    ...
    description: "Total emeralds collected for Personal Bank.",
  },
  {
    id: "end-stone",
    eliteId: "end-stone",
  ...
  },
  {
    ...
    description: "Total gemstones mined in Crystal Hollows & Glacite Tunnels.",
  },
  {
    id: "glacite",
    eliteId: "glacite",
  ...
  },
  {
    ...
    description: "Total gold mined or collected for Bank & Golden Dragon.",
  },
  {
    id: "gravel",
    eliteId: "gravel",
  ...
  },
  {
    ...
    description: "Total lapis mined for Experience Bottles.",
  },
  {
    id: "mithril",
    eliteId: "mithril",
  ...
  },
  {
    ...
    description: "Total mycelium excavated on the Mage faction side.",
  },
  {
    id: "nether-quartz",
    eliteId: "nether-quartz",
    name: "Nether Quartz",
    group: "mining",
    unit: "nether quartz",
    iconId: "QUARTZ",
    collectionKeys: ["QUARTZ", "NETHER_QUARTZ"],
    description: "Total quartz mined or generated.",
  },
  {
    id: "netherrack",
    eliteId: "netherrack",
    ...
    description: "Total netherrack mined across the Crimson Isle.",
  },
  {
    id: "obsidian",
    eliteId: "obsidian",
    ...
    description: "Total obsidian mined in Obsidian Sanctuary.",
  },
  {
    id: "red-sand",
    eliteId: "red-sand",
  ...
  },
  {
    ...
    iconId: "SAND",
    collectionKeys: ["SAND"],
    description: "Total sand mined or generated.",
  },
  {
    id: "sulphur",
    eliteId: "sulphur",
  ...
  },
  {
    ...
    description: "Total pumpkins harvested.",
  },
  {
    id: "melon",
    eliteId: "melon",
  ...
  },
  {
    ...
    description: "Total red and brown mushrooms farmed.",
  },
  {
    id: "cocoa",
    eliteId: "cocoa",
  ...
  },
  {
    ...
    description: "Total cactus harvested.",
  },
  {
    id: "sugarcane",
    eliteId: "sugarcane",
  ...
  },
  {
    ...
    description: "Total nether wart farmed.",
  },
  {
    id: "raw-chicken",
    eliteId: "raw-chicken",
  ...
  },
  {
    ...
    description: "Total rabbit meat collected.",
  },
  {
    id: "mutton",
    eliteId: "mutton",
  ...
  {
    id: "raw-porkchop",
    eliteId: "raw-porkchop",
    name: "Raw Porkchop",
    group: "farming",
    unit: "raw porkchop",
    iconId: "PORK",
    collectionKeys: ["PORK", "RAW_PORKCHOP"],
    description: "Total raw porkchop collected.",
  },
  ...
  },
  {
    ...
    iconId: "BONE",
    collectionKeys: ["BONE"],
    description: "Total skeleton bones collected.",
  },
  {
    id: "chili-pepper",
    eliteId: "chili-pepper",
    name: "Chili Pepper",
    group: "combat",
    unit: "chili peppers",
    iconId: "NETHER_STALK",
    collectionKeys: ["CHILI_PEPPER"],
    description: "Total chili peppers collected.",
  },
  {
    id: "ender-pearl",
    eliteId: "ender-pearl",
  ...
  },
  {
    ...
    description: "Total ghast tears collected.",
  },
  {
    id: "gunpowder",
    eliteId: "gunpowder",
    ...
    description: "Total gunpowder collected.",
  },
  {
    id: "magma-cream",
    eliteId: "magma-cream",
    ...
    description: "Total magma cream collected.",
  },
  {
    id: "rotten-flesh",
    eliteId: "rotten-flesh",
    name: "Rotten Flesh",
    group: "combat",
    unit: "rotten flesh",
    iconId: "ROTTEN_FLESH",
    collectionKeys: ["ROTTEN_FLESH"],
    description: "Total rotten flesh collected.",
  },
  {
    id: "slimeball",
    eliteId: "slimeball",
    ...
    description: "Total slimeballs collected.",
  },
  {
    id: "spider-eye",
    eliteId: "spider-eye",
    ...
    description: "Total spider eyes collected.",
  },
  {
    id: "string",
    eliteId: "string",
    ...
    iconId: "STRING",
    collectionKeys: ["STRING"],
    description: "Total spider string collected.",
  },
  ...
  // ==========================================
  {
    ...
    unit: "acacia wood",
    iconId: "LOG_2",
    collectionKeys: ["LOG_2", "ACACIA_LOG"],
    description: "Total acacia wood chopped in the Park.",
  },
  {
    id: "birch",
    eliteId: "birch",
    ...
    unit: "birch wood",
    iconId: "LOG:2",
    collectionKeys: ["LOG:2", "BIRCH_LOG"],
    description: "Total birch wood chopped.",
  },
  {
    id: "dark-oak",
    eliteId: "dark-oak",
    ...
    unit: "dark oak wood",
    iconId: "LOG_2:1",
    collectionKeys: ["LOG_2:1", "DARK_OAK_LOG"],
    description: "Total dark oak chopped in the Dark Thicket.",
  },
  {
    id: "jungle",
    eliteId: "jungle",
    ...
    unit: "jungle wood",
    iconId: "LOG:3",
    collectionKeys: ["LOG:3", "JUNGLE_LOG"],
    description: "Total jungle wood chopped.",
  },
  {
    id: "oak",
    eliteId: "oak",
    ...
    unit: "oak wood",
    iconId: "LOG",
    collectionKeys: ["LOG", "OAK_LOG"],
    description: "Total oak wood chopped.",
  },
  {
    id: "spruce",
    eliteId: "spruce",
    ...
    unit: "spruce wood",
    iconId: "LOG:1",
    collectionKeys: ["LOG:1", "SPRUCE_LOG"],
    description: "Total spruce wood chopped.",
  },
  {
    id: "mangrove",
    eliteId: "mangrove",
    ...
    unit: "mangrove wood",
    iconId: "LOG",
    collectionKeys: ["MANGROVE_LOG"],
    description: "Total mangrove chopped.",
  },
  {
    id: "fig",
    eliteId: "fig",
    ...
    unit: "fig logs",
    iconId: "LOG:2",
    collectionKeys: ["FIG_LOG"],
    description: "Total fig logs harvested.",
  },
  {
    id: "sea-lumies",
    eliteId: "sea-lumies",
    ...
    group: "foraging",
    unit: "sea lumies",
    iconId: "PRISMARINE_CRYSTALS",
    collectionKeys: ["SEA_LUMIES"],
    description: "Total sea lumies gathered.",
  },
  {
    id: "vinesap",
    eliteId: "vinesap",
    ...
    unit: "vinesap",
    iconId: "INK_SACK:2",
    collectionKeys: ["VINESAP"],
    description: "Total vinesap collected.",
  },
  {
    id: "lushlilac",
    eliteId: "lushlilac",
    ...
    unit: "lushlilac",
    iconId: "RED_ROSE:1",
    collectionKeys: ["LUSHLILAC"],
    description: "Total lushlilac flowers collected.",
  },
  {
    id: "tender-wood",
    eliteId: "tender-wood",
    ...
    unit: "tender wood",
    iconId: "LOG_2:1",
    collectionKeys: ["TENDER_WOOD"],
    description: "Total tender wood chopped.",
  },
  {
    id: "helix-log",
    eliteId: "helix-log",
    ...
    unit: "helix logs",
    iconId: "LOG:3",
    collectionKeys: ["HELIX_LOG"],
    description: "Total helix logs chopped.",
  },
  {
    id: "ruby-veilshroom",
    eliteId: "ruby-veilshroom",
    name: "Ruby Veilshroom",
    group: "foraging",
    unit: "ruby veilshroom",
    iconId: "RED_MUSHROOM",
    collectionKeys: ["RUBY_VEILSHROOM"],
    description: "Total ruby veilshroom gathered.",
  },
  {
    id: "honeycomb",
    eliteId: "honeycomb",
    ...
    unit: "honeycomb",
    iconId: "GOLD_BLOCK",
    collectionKeys: ["HONEYCOMB"],
    description: "Total honeycomb gathered.",
  },
  ...
  // ==========================================
  {
    ...
    unit: "clay",
    iconId: "CLAY_BALL",
    collectionKeys: ["CLAY_BALL", "CLAY"],
    description: "Total clay fished or generated via clay minions.",
  },
  {
    id: "clownfish",
    eliteId: "clownfish",
    ...
    unit: "clownfish",
    iconId: "RAW_FISH:2",
    collectionKeys: ["RAW_FISH:2", "CLOWNFISH"],
    description: "Total clownfish caught.",
  },
  {
    id: "ink-sac",
    eliteId: "ink-sac",
    ...
    unit: "ink sacs",
    iconId: "INK_SACK",
    collectionKeys: ["INK_SACK", "INK_SAC"],
    description: "Total ink sacs fished from Squids.",
  },
  {
    id: "lily-pad",
    eliteId: "lily-pad",
    ...
    unit: "lily pads",
    iconId: "WATER_LILY",
    collectionKeys: ["WATER_LILY", "LILY_PAD"],
    description: "Total lily pads fished for Rod of the Sea.",
  },
  {
    id: "magmafish",
    eliteId: "magmafish",
    ...
    unit: "magmafish",
    iconId: "RAW_FISH:1",
    collectionKeys: ["MAGMAFISH"],
    description: "Total magmafish caught in lava.",
  },
  {
    id: "prismarine-crystals",
    eliteId: "prismarine-crystals",
    name: "Prismarine Crystals",
    group: "fishing",
    unit: "crystals",
    iconId: "PRISMARINE_CRYSTALS",
    collectionKeys: ["PRISMARINE_CRYSTALS"],
    description: "Total prismarine crystals fished from Sea Guardians.",
  },
  {
    id: "prismarine-shard",
    eliteId: "prismarine-shard",
    name: "Prismarine Shard",
    group: "fishing",
    unit: "shards",
    iconId: "PRISMARINE_SHARD",
    collectionKeys: ["PRISMARINE_SHARD"],
    description: "Total prismarine shards fished.",
  },
  {
    id: "pufferfish",
    eliteId: "pufferfish",
    ...
    unit: "pufferfish",
    iconId: "RAW_FISH:3",
    collectionKeys: ["RAW_FISH:3", "PUFFERFISH"],
    description: "Total pufferfish caught.",
  },
  {
    id: "raw-fish",
    eliteId: "raw-fish",
    ...
    unit: "raw fish",
    iconId: "RAW_FISH",
    collectionKeys: ["RAW_FISH"],
    description: "Total raw fish caught.",
  },
  {
    id: "raw-salmon",
    eliteId: "raw-salmon",
    ...
    unit: "raw salmon",
    iconId: "RAW_FISH:1",
    collectionKeys: ["RAW_FISH:1", "RAW_SALMON"],
    description: "Total raw salmon caught.",
  },
  {
    id: "sponge",
    eliteId: "sponge",
    ...
    unit: "sponge",
    iconId: "SPONGE",
    collectionKeys: ["SPONGE"],
    description: "Total sponge fished for Sponge Armor.",
  },
  {
    id: "lotus",
    eliteId: "lotus",
    ...
    unit: "lotus",
    iconId: "WATER_LILY",
    collectionKeys: ["LOTUS"],
    description: "Total lotus gathered.",
  },
  ...
  {
    id: "agaricus-cap",
    eliteId: "agaricus-cap",
    name: "Agaricus Cap",
    group: "rift",
    unit: "agaricus cap",
    iconId: "RED_MUSHROOM",
    collectionKeys: ["AGARICUS_CAP"],
    description: "Total agaricus caps harvested in the Rift.",
  },
  {
    id: "caducous-stem",
    eliteId: "caducous-stem",
    name: "Caducous Stem",
    group: "rift",
    unit: "caducous stem",
    iconId: "NETHER_STALK",
    collectionKeys: ["CADUCOUS_STEM"],
    description: "Total caducous stems harvested in the Rift.",
  },
  {
    id: "half-eaten-carrot",
    eliteId: "half-eaten-carrot",
    name: "Half-Eaten Carrot",
    group: "rift",
    unit: "half-eaten carrots",
    iconId: "CARROT_ITEM",
    collectionKeys: ["HALF_EATEN_CARROT"],
    description: "Total half-eaten carrots collected in the Rift.",
  },
  {
    id: "hemovibe",
    eliteId: "hemovibe",
    ...
    unit: "hemovibe",
    iconId: "REDSTONE",
    collectionKeys: ["HEMOVIBE"],
    description: "Total hemovibes collected in the Rift.",
  },
  {
    id: "living-metal-heart",
    eliteId: "living-metal-heart",
    name: "Living Metal Heart",
    group: "rift",
    unit: "living metal hearts",
    iconId: "IRON_INGOT",
    collectionKeys: ["LIVING_METAL_HEART"],
    description: "Total living metal hearts forged.",
  },
  {
    id: "wilted-berberis",
    eliteId: "wilted-berberis",
    name: "Wilted Berberis",
    group: "rift",
    unit: "wilted berberis",
    iconId: "DEAD_BUSH",
    collectionKeys: ["WILTED_BERBERIS"],
    description: "Total wilted berberis gathered.",
  },
  {
    id: "timite",
    eliteId: "timite",
    ...
    unit: "timite",
    iconId: "LAPIS_LAZULI",
    collectionKeys: ["TIMITE"],
    description: "Total timite extracted.",
  },
  ...
  // ==========================================
  {
    ...
    iconId: "WITHER_SKULL",
    collectionKeys: [],
    description: "Total Catacombs Experience earned.",
  },
  {
    id: "archer-xp",
    eliteId: "archer-xp",
    ...
    iconId: "BOW",
    collectionKeys: [],
    description: "Total Archer Class Experience.",
  },
  {
    id: "berserk-xp",
    eliteId: "berserk-xp",
    ...
    collectionKeys: [],
    description: "Total Berserk Class Experience.",
  },
  {
    id: "healer-xp",
    eliteId: "healer-xp",
    ...
    iconId: "GOLDEN_APPLE",
    collectionKeys: [],
    description: "Total Healer Class Experience.",
  },
  {
    id: "mage-xp",
    eliteId: "mage-xp",
    ...
    iconId: "BLAZE_ROD",
    collectionKeys: [],
    description: "Total Mage Class Experience.",
  },
  {
    id: "tank-xp",
    eliteId: "tank-xp",
    ...
    group: "dungeons",
    unit: "Tank XP",
    iconId: "DIAMOND_CHESTPLATE",
    collectionKeys: [],
    description: "Total Tank Class Experience.",
  },
  ...
  // ==========================================
  {
    ...
    iconId: "DIAMOND_SWORD",
    collectionKeys: [],
    description: "Combined Slayer Experience across all bosses.",
  },
  {
    id: "zombie-slayer",
    eliteId: "zombie-slayer",
    name: "Zombie Slayer XP",
    group: "slayers",
    unit: "Revenant XP",
    iconId: "ROTTEN_FLESH",
    collectionKeys: [],
    description: "Total Revenant Horror Slayer XP.",
  },
  {
    id: "spider-slayer",
    eliteId: "spider-slayer",
    name: "Spider Slayer XP",
    group: "slayers",
    unit: "Tarantula XP",
    iconId: "SPIDER_EYE",
    collectionKeys: [],
    description: "Total Tarantula Broodfather Slayer XP.",
  },
  {
    id: "wolf-slayer",
    eliteId: "wolf-slayer",
    ...
    iconId: "MUTTON",
    collectionKeys: [],
    description: "Total Sven Packmaster Slayer XP.",
  },
  {
    id: "enderman-slayer",
    eliteId: "enderman-slayer",
    name: "Enderman Slayer XP",
    group: "slayers",
    unit: "Voidgloom XP",
    iconId: "ENDER_PEARL",
    collectionKeys: [],
    description: "Total Voidgloom Seraph Slayer XP.",
  },
  {
    id: "blaze-slayer",
    eliteId: "blaze-slayer",
    name: "Blaze Slayer XP",
    group: "slayers",
    unit: "Inferno XP",
    iconId: "BLAZE_ROD",
    collectionKeys: [],
    description: "Total Inferno Demonlord Slayer XP.",
  },
  {
    id: "vampire-slayer",
    eliteId: "vampire-slayer",
    name: "Vampire Slayer XP",
    group: "slayers",
    unit: "Bloodfiend XP",
    iconId: "RED_MUSHROOM",
    collectionKeys: [],
    description: "Total Riftstalker Bloodfiend Slayer XP.",
  },
  ...
  // ==========================================
  {
    id: "skyblockxp",
    eliteId: "skyblockxp",
    name: "SkyBlock Level (XP)",
    group: "skills",
    unit: "SB XP",
    iconId: "NETHER_STAR",
    collectionKeys: [],
    description: "Total SkyBlock Experience.",
  },
  {
    id: "farmingweight",
    eliteId: "farmingweight",
    name: "Farming Weight",
    group: "skills",
    unit: "weight",
    iconId: "HAY_BLOCK",
    collectionKeys: [],
    description: "Official Elite SkyBlock Farming Weight calculation.",
  },
  {
    id: "combat",
    eliteId: "combat",
    ...
    iconId: "DIAMOND_SWORD",
    collectionKeys: [],
    description: "Total Combat Skill Experience.",
  },
  {
    id: "farming",
    eliteId: "farming",
    ...
    iconId: "WHEAT",
    collectionKeys: [],
    description: "Total Farming Skill Experience.",
  },
  {
    id: "mining",
    eliteId: "mining",
    ...
    group: "skills",
    unit: "Mining XP",
    iconId: "DIAMOND_PICKAXE",
    collectionKeys: [],
    description: "Total Mining Skill Experience.",
  },
  {
    id: "foraging",
    eliteId: "foraging",
    ...
    iconId: "OAK_LOG",
    collectionKeys: [],
    description: "Total Foraging Skill Experience.",
  },
  {
    id: "fishing",
    eliteId: "fishing",
    ...
    iconId: "FISHING_ROD",
    collectionKeys: [],
    description: "Total Fishing Skill Experience.",
  },
  {
    id: "enchanting",
    eliteId: "enchanting",
    ...
    group: "skills",
    unit: "Enchanting XP",
    iconId: "ENCHANTING_TABLE",
    collectionKeys: [],
    description: "Total Enchanting Skill Experience.",
  },
  {
    id: "alchemy",
    eliteId: "alchemy",
    ...
    group: "skills",
    unit: "Alchemy XP",
    iconId: "BREWING_STAND",
    collectionKeys: [],
    description: "Total Alchemy Skill Experience.",
  },
  {
    id: "bestiary",
    eliteId: "bestiary",
    ...
    iconId: "BOOK",
    collectionKeys: [],
    description: "Total mob kills registered in the Bestiary.",
  },
  {
    id: "magical-power",
    eliteId: "magical-power",
    name: "Magical Power",
    group: "skills",
    unit: "MP",
    iconId: "POTION",
    collectionKeys: [],
    description: "Total Accessory Bag Magical Power.",
  },
  {
    id: "fairy-souls",
    eliteId: "fairy-souls",
    ...
    iconId: "NETHER_STAR",
    collectionKeys: [],
    description: "Total Fairy Souls collected.",
  },
  ...
  {
    id: "networth-normal",
    eliteId: "networth-normal",
    name: "Normal Net Worth",
    group: "economy",
    unit: "coins",
    iconId: "GOLD_INGOT",
    collectionKeys: [],
    description: "Estimated total coin valuation across profile items and bank.",
  },
  {
    id: "networth-functional",
    eliteId: "networth-functional",
    name: "Functional Net Worth",
    group: "economy",
    unit: "coins",
    iconId: "CHEST",
    collectionKeys: [],
    description: "Valuation of usable gear, weapons, and accessories.",
  },
  {
    id: "networth-liquid",
    eliteId: "networth-liquid",
    name: "Liquid Purse & Bank",
    group: "economy",
    unit: "coins",
    iconId: "GOLD_NUGGET",
    collectionKeys: [],
    description: "Total cash coins held in purse, bank, and co-op accounts.",
  },
];
 ...
 */
export async function fetchEliteLeaderboard(
  leaderboardId: string,
): Promise<EliteLeaderboardResponse | null> {
  try {
...
export function calculatePlayerLeaderboardStandings(
  player: {
    ...
    dungeons?:
      | { catacombsLevel?: number | null | undefined; catacombsXp?: number | null | undefined }
      | null
      | undefined;
  ...
  for (const sub of LEADERBOARD_SUBCATEGORIES) {
    ...
    if (sub.group === "skills") {
      ...
      playerVal =
        player.dungeons?.catacombsXp ??
        (player.dungeons?.catacombsLevel ? player.dungeons.catacombsLevel * 100_000 : 0);
    ...
    if (playerVal <= 0) {
      ...
      exactRankNumber = Math.max(
        2,
        Math.round(100 - ((playerVal - top100Val) / (top1Val - top100Val)) * 98),
      );
      ...
      for (let i = 0; i < playerUuid.length; i++)
        hash = (hash * 31 + playerUuid.charCodeAt(i)) % 10000;
