...
export const RIFT_TIMECHARMS: TimecharmDefinition[] = [
  {
    ...
    location: "Wyld Woods",
    bonusTimeSeconds: 60,
    obtainedFrom: "Kat Questline",
  },
  {
    id: "enigma",
    name: "Enigma Timecharm",
    location: "Enigma's Crib",
    bonusTimeSeconds: 60,
    obtainedFrom: "20 Enigma Souls",
  },
  {
    id: "dreadfarm",
    name: "Dreadfarm Timecharm",
    location: "Dreadfarm",
    bonusTimeSeconds: 60,
    obtainedFrom: "Farmhand Quests",
  },
  {
    id: "mountain",
    name: "Mountain Timecharm",
    location: "Colosseum Mountain",
    bonusTimeSeconds: 60,
    obtainedFrom: "Mountain Top",
  },
  {
    id: "west_village",
    name: "West Village Timecharm",
    location: "West Village",
    bonusTimeSeconds: 60,
    obtainedFrom: "Mayor Election",
  },
  {
    id: "mirrorverse",
    name: "Mirrorverse Timecharm",
    location: "Mirrorverse",
    bonusTimeSeconds: 90,
    obtainedFrom: "Mirrorverse Puzzles",
  },
  {
    id: "blood",
    name: "Blood Timecharm",
    location: "Stillgore Chateau",
    bonusTimeSeconds: 90,
    obtainedFrom: "Vampire Slayer T4",
  },
  {
    id: "barrier",
    name: "Barrier Timecharm",
    location: "Dreadfarm Edge",
    bonusTimeSeconds: 90,
    obtainedFrom: "Rift Barrier Unlock",
  },
];
...
export const VAMPIRE_SLAYER_TIERS: VampireBossTier[] = [
  {
    ...
    name: "Bloodfiend I",
    hp: "1,000",
    requiredWeapon: "Silver Stake",
    mechanics: ["Basic attacks", "Stake finisher"],
    moteCost: 500,
    slayerXp: 5,
  },
  {
    ...
    hp: "5,000",
    requiredWeapon: "Silver Stake",
    mechanics: ["Healing circles", "Stake finisher"],
    moteCost: 1500,
    slayerXp: 25,
  },
  {
    ...
    hp: "25,000",
    requiredWeapon: "Silver Stake",
    mechanics: ["Mania phase", "Blood beams", "Holy Ice"],
    moteCost: 5000,
    slayerXp: 100,
  },
  {
    ...
    name: "Bloodfiend IV",
    hp: "150,000",
    requiredWeapon: "Steak Stake",
    mechanics: ["Twinclaws", "Mania blood jump", "Impel aura", "Holy Ice timing"],
    moteCost: 15000,
    slayerXp: 500,
  },
  {
    ...
    name: "Bloodfiend V",
    hp: "750,000",
    requiredWeapon: "Steak Stake (Reforged)",
    mechanics: ["Quad Mania", "Hyper-speed Twinclaws", "Death pulse", "Sub-second Holy Ice"],
    moteCost: 50000,
    slayerXp: 1500,
  },
];
...
export const RIFT_EXPORT_ITEMS: RiftExportItem[] = [
  {
    name: "Rift Prism",
    motesCost: 500_000,
    realSkyBlockValueCoins: 350_000_000,
    coinsPerMote: 700,
  },
  {
    name: "Shen's Auction Relics",
    motesCost: 250_000,
    realSkyBlockValueCoins: 120_000_000,
    coinsPerMote: 480,
  },
  {
    name: "MC0-1 Microcontroller",
    motesCost: 100_000,
    realSkyBlockValueCoins: 42_000_000,
    coinsPerMote: 420,
  },
  {
    name: "Half-Eaten Carrot",
    motesCost: 15_000,
    realSkyBlockValueCoins: 4_500_000,
    coinsPerMote: 300,
  },
];
